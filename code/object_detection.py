...
def train(data_yaml, img_size, model_size='yolov8n.pt', epochs=50, batch_size=8, save_dir='runs/train'):
    """
    Train the YOLOv8 model.
    
    :param model_size: Pre-trained model size ('yolov8n.pt', 'yolov8s.pt', etc.).
    :param data_yaml: Path to the YAML file with dataset info. ('data.yaml')
